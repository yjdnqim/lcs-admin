...
<%-- --%>
				...
				<ul class="nav nav-list">
					<%--<li class="active" id="fhindex">
					  <a href="main/index"><i class="icon-dashboard"></i><span>控制台</span></a>
					</li>
				...
				<c:if test="${menu.hasMenu}">
					<c:if test="${menu.MENU_URL != '#'}">
						<li id="z${menu.MENU_ID}">
						  <a style="cursor:pointer;" target="mainFrame" onclick="siMenu('z${menu.MENU_ID }',null,'${menu.MENU_NAME }','${menu.MENU_URL }')">
