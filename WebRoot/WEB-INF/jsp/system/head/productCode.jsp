...
<html lang="en">
	<head>
		...
		.commitbox_cen div.right span.moveup{border:solid 1px #c7c7c7; background:#00BFFF; border-radius:3px; color:#FFF; padding:4px 9px;}
		.commitbox_cen div.right span.movedown{border:solid 1px #c7c7c7; background:#00BFFF; border-radius:3px; color:#FFF; padding:4px 9px;}
		</style>
