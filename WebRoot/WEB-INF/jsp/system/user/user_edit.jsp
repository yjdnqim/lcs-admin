	...
	<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<tr class="info">
				<th>权限:</th>
				<td>
				<select class="chzn-select" name="ROLE_ID" id="role_id" data-placeholder="请选择权限" style="vertical-align:top;">
				<option value=""></option>
			...
			<tr>
				<th>账号:</th>
				<td><input type="text" name="USERNAME" id="loginname" value="${pd.USERNAME}" maxlength="32" placeholder="这里输入账号" title="账号"/></td>
			</tr>
			<tr>
				<th>密码:</th>
