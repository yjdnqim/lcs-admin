...
public class WXPay {
 ...
 /**
    ...
    public Map<String, String> newFillRequestData(Map<String, String> reqData) throws Exception {
        ...
        String signTypes = reqData.get("sign_type");
        SignType typeSign= null;
        if(signTypes == null) {
        	...
        	typeSign = this.signType;
        }
        if(WXPayConstants.MD5.equals(signTypes)) {
        	typeSign = SignType.MD5;
        	ConstantUtil.typeSign = SignType.MD5;
        }else if(WXPayConstants.HMACSHA256.equals(signTypes)) {
        	typeSign = SignType.HMACSHA256;
        	ConstantUtil.typeSign = SignType.HMACSHA256;
        }
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), typeSign));
        System.out.println("------------------new******向 Map 中添加 appid、mch_id、nonce_str、sign_type、sign---------------");
        System.out.println("reqData.get(\"sign_type\"):"+reqData.get("sign_type"));
        System.out.println("SignType.MD5:"+SignType.MD5);
        System.out.println("SignType.MD5:"+SignType.HMACSHA256);
        System.out.println("sign_type:"+this.signType);//sign_type:HMACSHA256
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        System.out.println("------------------worn******向 Map 中添加 appid、mch_id、nonce_str、sign_type、sign---------------");
        System.out.println("reqData.get(\"sign_type\"):"+reqData.get("sign_type"));
        System.out.println("SignType.MD5:"+SignType.MD5);
        System.out.println("SignType.MD5:"+SignType.HMACSHA256);
        System.out.println("sign_type:"+this.signType);//sign_type:HMACSHA256
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        // 返回数据的签名方式和请求中给定的签名方式是一致的            //原来this.signType
        return WXPayUtil.isSignatureValid(reqData, this.config.getKey(), ConstantUtil.typeSign);
    }
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        System.out.println("reqData:"+reqData);
        System.out.println("connectTimeoutMs:"+connectTimeoutMs);
        System.out.println("readTimeoutMs:"+readTimeoutMs);
        
        String respXml = this.requestWithoutCert(url, this.newFillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
